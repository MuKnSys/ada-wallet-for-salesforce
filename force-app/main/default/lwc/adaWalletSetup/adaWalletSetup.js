...
export default class AdaWalletSetup extends LightningElement {
    ...
    async handleBlockfrostSave() {
        ...
        try {
            ...
            showToast(this, this.labels.CORE.Success, 'Blockfrost Project ID saved successfully', TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
    ...
    async handleBlockfrostRemove() {
        ...
        try {
            ...
            showToast(this, this.labels.CORE.Success, 'Settings removed successfully', TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
            await this.loadSetup();
        } catch (error) {
    ...
    async handleTestBlockfrostConfig() {
        ...
        try {
            ...
            showToast(this, this.labels.CORE.Success, 'Blockfrost configuration tested successfully', TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
        } catch (error) {
    ...
    async handlePrivateKey() {
        ...
        try {
            ...
            this.processSetupData(result);
            showToast(this, this.labels.CORE.Success, this.labels.CORE.Success_Info, TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
        } catch (error) {
            const errorMessage = error.body ? error.body.message : error.message;
            showToast(this, 'Error', errorMessage, TOAST_VARIANT.ERROR, TOAST_MODE.ERROR);
        } finally {
    ...
    async handleEnableLogging() {
        ...
        try {
            await enableLogging();
            showToast(this, this.labels.CORE.Success, this.labels.LOGGING.EnableSuccess, TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
        } catch (error) {
            const errorMessage = error.body ? error.body.message : error.message;
            showToast(this, 'Error', errorMessage, TOAST_VARIANT.ERROR, TOAST_MODE.ERROR);
        } finally {
    ...
    async handleDisableLogging() {
        ...
        try {
            ...
            showToast(this, this.labels.CORE.Success, this.labels.LOGGING.DisableSuccess, TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
        } catch (error) {
            const errorMessage = error.body ? error.body.message : error.message;
            showToast(this, 'Error', errorMessage, TOAST_VARIANT.ERROR, TOAST_MODE.ERROR);
        } finally {
    ...
    async handleTransactionApprovalsChange(event) {
        ...
        try {
            ...
            showToast(this, this.labels.CORE.Success, 'Transaction approvals setting updated successfully', TOAST_VARIANT.SUCCESS, TOAST_MODE.SUCCESS);
        } catch (error) {
