...
import { definitions, visitorKeys } from './definitions.mjs';
import { getNodeValidationEnabled } from './builders.mjs';
...
export class NodePath {
    ...
    init(parentScope) {
        ...
        if (this.ctx.makeScope) {
            this.scope = Scope.for(this, parentScope || ((_a = this.parentPath) === null || _a === void 0 ? void 0 : _a.scope) || null);
            if (this.scope != null)
                this.scope.init();
        }
        return this;
    ...
    onRemove() {
        ...
        if (this.scope != null)
            Scope.handleRemoval(this.scope, this);
        return false;
    }
    markRemoved() {
        var _a;
