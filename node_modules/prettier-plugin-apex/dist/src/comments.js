...
// continue; /* Comment */
// ```
function handleContinueBreakDanglingComment(comment) {
    const { enclosingNode } = comment;
    if (!enclosingNode) {
        return false;
    }
    if (enclosingNode["@class"] === APEX_TYPES.CONTINUE_STATEMENT ||
        enclosingNode["@class"] === APEX_TYPES.BREAK_STATEMENT) {
        addTrailingComment(enclosingNode, comment);
        return true;
    }
    if (enclosingNode["@class"] === APEX_TYPES.RETURN_STATEMENT &&
