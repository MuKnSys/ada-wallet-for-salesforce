...
type OptionalTransformKeys = 'name' | 'namespace' | 'scopedStyles' | 'customRendererConfig' | 'enableLwcSpread' | 'enableLwcOn' | 'enableLightningWebSecurityTransforms' | 'enableDynamicComponents' | 'enableSyntheticElementInternals' | 'experimentalDynamicDirective' | 'experimentalDynamicComponent' | 'componentFeatureFlagModulePath' | 'instrumentation';
...
export interface NormalizedTransformOptions extends RequiredTransformOptions, OptionalTransformOptions {
}
/**
